    ...
    <section className="flexCenter flex-col">
      <div className='padding-container max-container
       w-full pb-24'>
        ...
        <div className='flex flex-wrap justify-between gap-5 lg:gap-10'>
          ...
          <p className='regular-16 text-gray-500 xl:max-w-[520px] xl:regular-20'>
            ...
            relatives and friends to have fun in the wilderness through
      ...
      <div className='flexCenter max-container relative w-full'>
        <Image 
          ...
          className='w-full object-cover object-cover 2xl:rounded-5xl'
        />
